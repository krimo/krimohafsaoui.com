<?php get_header(); ?>
			...
			<aside class="sidebar single-post-info">
				<?php edit_post_link(); ?>
				<ul>
					<li>Project type: <?php get_post_meta($post->ID, 'kh_project_type', true); ?></li>
					<li>Client: <?php get_post_meta($post->ID, 'kh_project_client', true); ?></li>
					<li>Date: <?php get_post_meta($post->ID, 'kh_project_date', true); ?></li>
				</ul>
			</aside>
